...
async fn test_search_recipes_no_query() {
    ...
    let result = env.client.search_recipes(None, Some(5), None, None, None, None, None).await;
...
async fn test_search_recipes_with_query() {
    ...
    let result = env.client.search_recipes(Some("pasta"), Some(5), None, None, None, None, None).await;
